...
jQuery(function($) {
	$('a.user').click(function(){
		...
		$.ajax({
			type: 'POST',
			cache: false,
			 url: "<?php echo site_url('admin/admin/installment')?>",
...
<div class="box">
  ...
  <tr>
    ...
    <table width="960" border="0" cellspacing="0" cellpadding="0">
      <tr><br>
        <td width="25%" height="98" style="padding:40px; padding-top:55px"><div class="number_txt"><?php echo number_format(round($rows[0]['amount']),0,'.',",")." " .""?></div></td>
   ...
   <tr>
    <td  dir="rtl" colspan="0" align="center"><table width="960" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="154"><div class="cheque_txt2"><?php echo number_format(round($rem->amount),0,'.',",")." " .""?></div></td>
