		...
		<div id="message-success" class="message message-success">
					...
					<?php if(empty($rows)){?>
						...
						<table id="emp" border="2" class="jtable">
					        <thead><tr><th>رقم </th><th>المؤجر</th><th>المستاجر</th><th>الوحدة</th><th>تاريخ الإنتهاء</th><th>العقار</th><th>الجوال</th><th>تحرير</th></tr></thead>
					         <tbody>
					        		...
					        		$name   = $this->type->get_by_id($estate[0]['estate_type']);
					      			...
					      			?>
					                	<tr>
						                   ...
						                   <td><?php echo endDate($list['id']);?></td>
