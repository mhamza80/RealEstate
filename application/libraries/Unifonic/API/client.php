...
class Client
{
    ...
    public function __construct()
    {
        ...
        $ci->load->library('Unifonic/API/Account/Account');
        $ci->load->library('Unifonic/API/Message/Message');
        $ci->load->library('Unifonic/API/Verify/Verify');
        $ci->load->library('Unifonic/API/Voice/Voice');
