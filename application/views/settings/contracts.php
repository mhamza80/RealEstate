...
<?php if ($this->session->flashdata('sucess')){?>
		<div id="message-success" class="message message-success">
			...
			<div id="dialog-add-contracts" title="إضافة">
				<p class="validateTips">جميع الحقول إحبارية.</p>
				<?php echo form_open_multipart('admin/settings/add_contracts','id=myform' )?>
			<div class="form">
				<div class="fields">
					<div class="field">
						<div class="label">
			...
			<input type="hidden" id="details" name="type"  value="3">
			<?php echo form_close();?>
		</div>
				<div class="table">
					<?php if(empty($rows)){?>
							<button id="add-contracts" class="add-button">إضافة</button> <br/>
							<div id="message-warning" class="message message-warning">
								...
								<div class="text">
									<span><?php echo "برجاء تحديد عدد الإيام لفحص العقود الطويلة"?></span>
								</div>
								<div class="dismiss">
									...
									<table id="emp" border="2" class="jtable">
					                	...
					                	<tr>
						                   ...
						                   <?php if($this->session->userdata('rols') == 1):?>
											...
											<?php
											echo anchor('admin/settings/edit_long/'.$list['id'].'/' .$list['id'],'تعديل','id=edit');
											?>
											</td>
											<?php endif;?>
					    	            </tr>
