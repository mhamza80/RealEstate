...
jQuery(function($) {
	$('a.user').click(function(){
		...
		$.ajax({
			type: 'POST',
			cache: false,
			 url: "<?php echo site_url('admin/admin/partial_voucher')?>",
...
<div class="box">
  ...
  <tr>
    ...
    <table width="960" border="0" cellspacing="0" cellpadding="0">
      <tr><br>
        <td width="25%" height="98" style="padding:40px; padding-top:44px"><div class="number_txt"><?php echo number_format(round($rows[0]['partial_pay']),0,'.',",")." " .""?></div></td>
  ...
  <tr>
    <td height="20" dir="rtl" colspan="0" align="center"><table width="960" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="750" height="18"   align="right" valign="top"><div class="name_txt"><?php echo $str = $this->convert_ar->money2str(round($rows[0]['partial_pay']), 'SAR', 'ar');?></div></td>
  ...
  <tr>
    <td  dir="rtl" colspan="0" align="center"><table width="960" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="159"><div class="cheque_txt1"><?php echo number_format(round($rows[0]['partial_pay']),0,'.',",")?></div></td>
   ...
   <tr>
    <td  dir="rtl" colspan="0" align="center"><table width="960" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="154"><div class="cheque_txt2"><?php echo number_format(round($rem),0,'.',",")?></div></td>
