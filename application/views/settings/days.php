...
<?php if ($this->session->flashdata('sucess')){?>
		<div id="message-success" class="message message-success">
			...
			<input type="hidden" id="details" name="type"  value="0">
			<?php echo form_close();?>
		</div>
				<div class="table">
					<?php if(empty($rows)){?>
							...
							<div id="message-warning" class="message message-warning">
								...
								<div class="text">
									<span><?php echo "برجاء تحديد عدد الإيام لفحص الإيجار"?></span>
								</div>
								<div class="dismiss">
									...
									<table id="emp" border="2" class="jtable">
					                	...
					                	<tr>
						                   ...
						                   <?php if($this->session->userdata('rols') == 1):?>
											...
											<?php
											echo anchor('admin/settings/edit/'.$list['id'].'/' .$list['id'],'تعديل','id=edit');
											?>
											</td>
											<?php endif;?>
					    	            </tr>
